...
include "Fuelstation.php";
include "FuelstationColection.php";
...
if ($actionToDo == 'add') {
    ...
    echo $_SESSION['Fuelstations']->filter($_POST['owner'], $_POST['fuel']);
} elseif ($actionToDo == 'save') {
    $_SESSION['Fuelstations']->save();
} elseif ($actionToDo == 'load') {
    $_SESSION['Fuelstations']->load();
}
